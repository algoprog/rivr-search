...
Modified to use cURL by GreekDev (https://github.com/greekdev)
*******************************************************************************/

function gethtml($url, $cookies)
{
    $curl = curl_init();
...
class simple_html_dom {
    ...
    function load_file() {
        $args = func_get_args();
        $this->load(call_user_func_array('gethtml', $args), true);
    }
    ...
    function loadFile() {$args = func_get_args();$this->load(call_user_func_array('gethtml', $args), true);}
}
?>